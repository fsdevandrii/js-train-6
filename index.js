...
function copyObject(obj) {
  ...
  return { ...obj }; // Використовуємо деструктуризацію {...obj} для створення нового об'єкта з тими ж властивостями
}
...
let user = {
  ...
  // Використовуємо ключове слово this для отримання доступу до властивостей об'єкта
  introduce: function () {
...
function destructureObject(obj) {
  ...
  let { brand, model } = obj; // Використовуємо деструктуризацію для створення нових змінних з властивостей об'єкту
  return `Brand: ${brand}, Model: ${model}`; // Повертаємо нові змінні в потрібному форматі
}
...
function changeRole(array, newRole) {
  ...
  for (let user of array) {
    user.role = newRole; // Змінюємо роль кожного користувача на нове значення
...
function printProductDetails(obj) {
  ...
  } = obj; // Використовуємо деструктуризацію для отримання значень
...
let newArr = addProperty([1, 2, 3, 4, 5]); // Створюємо масив newArr з новою властивістю
